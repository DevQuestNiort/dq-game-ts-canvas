...
export class InventoryMenuState extends MenuState{
    ...
    constructor() {
        super()
        const entry1  = new IhmEntry("01",new Position((GRID_PITCH *  VIEWPORT_SIZE_X)/2 , GRID_PITCH*25), 20, "Retour au jeu",()=> console.log("retour au jeu"))

        this.entrys= [entry1]
        this.texts= [
            new IhmEntry("title", new Position((GRID_PITCH *  VIEWPORT_SIZE_X)/2 , GRID_PITCH*2),50,"Inventaire",undefined),
             ]
    }
