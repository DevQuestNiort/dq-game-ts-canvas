...
export const items = [
  ...
  new ComsumableItem(
    ...
    "Potion",
    new Position(17, 18),
    () => gameState.player.augmenterMaxLife(5),
    "Augmente la vie max de 5 points",
  ...
  new PNJItem(
    ...
    new ModalTemplate(
      "Turuk",
      "troll",
      "Gniak!!!! Que viens-tu faire aventurier... Ne commence pas à me chercher! Moi je garde la salle du trésor! Et je le fais bien! Donc va-t'en!",
    ),
  ),
  ...
  new DecorativeItem(
    ...
    new ModalTemplate(
      "Chateau d'iRule",
      "panneau",
      "Bienvenue au Dark iRule! Soyez prévenus, si vous y pénétrez, vous vous y risquez! Le maitre incontesté Browser, le méchant navigateur ainsi que ses fidèles sous fifres I'x et Cess vous chasseront sans cesse!",
    ),
  ),
  ...
  new PNJItem(
    ...
    "",
    "troll",
    new ModalTemplate("Yanok", "troll", "Team Fayos au bouloss"),
  ),
  ...
  new PickableItem(
    ...
    "Epee Magique augmentant l'attaque +3",
    "appuyer sur T pour prendre",
    "raresword",
  ),
  new PickableItem(
    ...
    "bouclier",
    new Position(77, 13),
    (player) => (player.defense += 5),
    "Bouclier De Ragnar, +5 en defense",
    "appuyer sur T pour prendre",
    "bouclier",
  ),
...
*/
  ...
  new UsableItem(
    ...
    "Vers le marécage",
    "appuyer sur T pour entrer dans le marécage",
    "vortex",
  ),
  ...
  new DecorativeItem(
    ...
    new ModalTemplate(
      "Marécage Passec",
      "panneau",
      "Voici le marécage Passec, le dernier repaire d'une race de serpent vorace. Nombreux sont les villageois qui ont disparu dans ce marécage.\n\n" +
        " Homage aux disparus\n" +
        " * Gaspar le maraicher\n" +
        " * René la taupe\n" +
  ...
  new PNJItem(
    ...
    new ModalTemplate(
      "Dame Damdeo",
      "elfe",
      "Pour rentrer dans ce marécage, il te faudra aller dans l'eau, Je possédais une gemme magique me permettant de marcher sur l'eau, mais une chèvre me la prise...\n" +
  ...
  new UsableItem(
    ...
    "Trappe d'accès",
    "appuyer sur T pour descendre dans le labyrinthe",
    "trapp",
  ),
  ...
  new PNJItem(
    ...
    new ModalTemplate(
      "La Poisse",
      "ogre02",
      "Ca fait longtemps que je n'avais pas vu une tête vivante... " +
  ...
  new UsableItem(
    ...
    "Trappe d'accès",
    "appuyer sur T pour descendre dans les prisons du château",
    "trapp",
  ),
  // ---------------------------
  ...
  new UsableItem(
    ...
    "Bateau",
    "appuyer sur T pour voyager vers l'île aux chèvres",
    "boat01",
  ),
  new UsableItem(
    "moveToIleDeserte",
  ...
  new DecorativeItem(
    ...
    new ModalTemplate(
      "DEVQUEST",
      "panneau",
      "Bienvenue dans cette quête, aventurier aventureux. Ne fait confiance à personne dans ce monde. Les dieux qui l'ont créé sont aussi fous qu'ils sont incompétents. Mais qui sait, une recompense est peut-être au bout de cette aventure!",
    ),
  ),
  ...
  new PNJItem(
    ...
    new ModalTemplate(
      "Shamin",
      "wizard",
      "Bienvenue sur Astenia jeune aventurier! Cette ville connait une histoire sombre en cette époque. Notre princesse L'IA s'est faite capturer par Browser, le maître du château.\n" +
  ...
  new PNJItem(
    ...
    new ModalTemplate(
      "Grodor",
      "ogre01",
      "Gnufur , Ferum dakiki...  Retro pedalo.... GRONCOLUPUK ! ",
    ),
  ),
