...
export const items = [
    new PickableItem("cm6uhwsdm0002vs63dzl0g70a", "chicken",  new Position(10, 13),(player) => player.attack+=3 , "poulet", "", "chicken"),
    new PickableItem("cm6uhwsdn0003vs63vjx18npm", "bouclier",  new Position(9, 13), (player) => player.defense+=5 , "Bouclier", "", "bouclier"),

    new ComsumableItem("cm6uhwsdn0004vs63z2xh2hfh", "Potion",  new Position(16, 16), (player) => player.life+=15 , "Potion de soin +15", "", "potion"),
    new UsableItem("cm6uiav5h000jvs633dm9oyj9", "Vortex",  new Position(13, 22), (player) => {movePlayerToPosition( 36 ,5)  }, "Potion de soin +15", "", "vortex"),
    new UsableItem("cm6uiryd9000kvs6308ahv6nm", "Vortex",  new Position(36, 5), (player) => {movePlayerToPosition( 13 ,22)  }, "Potion de soin +15", "", "vortex"),

    new PNJItem("cm6uj11q4000lvs63d6xka7h4", "Vincent",  new Position(10, 10),10,3,2, (stateContext) => {stateContext.mapStates[stateContext.currentMap].items.addItem(new ComsumableItem("cm6ul464y000mvs630qlpu3ik", "Potion",  new Position(10, 10), (player) => player.life+=15 , "Potion de soin +15", "", "potion"),)},"niak", "", "troll"),
