...
export const items = [
  ...
  new PickableItem(
    ...
    new Position(25, 46),
    () => {},
    "Collier du trappeur, détecte les pièges",
  ...
  new PNJItem(
    ...
    "",
    "troll",
    new ModalTemplate("Signark", "troll", "Gniak! On ne passe pas!"),
  ),
];
